...
class Article(YearTrends): # Статьи
...
class Progress(YearTrends): # Наиболее значимые достижения по направлениям НИР
...
class Reference(NameUnique100): # Полезные ссылки
...
class CultureGroup(NameUnique100): # Группа агрокультур, выращиваемых в НИИ
...
class Culture(NameUnique100): # Виды агрокультур, выращиваемых в НИИ
