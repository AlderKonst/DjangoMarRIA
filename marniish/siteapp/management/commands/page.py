...
new_news_pages_lists = [
    ['Новости за 2025 год', # title
     '2025', # url
     'Новости института за 2025 год на сайте Марийского НИИСХ, филиала ФБГНУ ФАНЦ Северо-Востока', # description
     'Trend', # parent_url
     'Направления деятельности'], # parent_title
] # Создаем список для хранения новых страниц
