...
pages_lists = [ # Создаем список для хранения страниц редактирования и добавляем в него данные в БД
    ...
    ['Новости',
     'Newses',
     'Новости института на сайте Марийского НИИСХ, филиала ФБГНУ ФАНЦ Северо-Востока'],
    ['Вход',
     'login',
     'Вход на сайт Марийского НИИСХ, филиала ФБГНУ ФАНЦ Северо-Востока'],
    ['Регистрация',
     'register',
     'Регистрация нового пользователя на сайте Марийского НИИСХ, филиала ФБГНУ ФАНЦ Северо-Востока'],
    ['Токен',
     'user_token',
     'Генерация токена пользователя для работы с API на сайте Марийского НИИСХ, филиала ФБГНУ ФАНЦ Северо-Востока'],
]
