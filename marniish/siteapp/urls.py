...
urlpatterns = [
    ...
    path('About/editing/add/', views.HistoryAddView.as_view(), name='About_editing_add'), # Добавление абзаца события
    path('About/editing/data_add/', views.HistoryDataAddView.as_view(), name='About_editing_data_add'), # Добавление даты события
